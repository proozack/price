import pprint
from app.modules.price.db_utils import OfertDbUtils, CategoryDbUtils, ProductDbUtils, TagWordLinkDbUtils
...
class ProductSupport():
    ...
    def parase_all_ofert(self, ofert_id=None, shop_id=None, entry_point_id=None) -> Ofert:
        odbu = OfertDbUtils()
        # log.info('To jest oferta %r', ofert_id)
        for ofert in odbu.get_all_oferts(ofert_id, shop_id, entry_point_id):
            yield ofert
